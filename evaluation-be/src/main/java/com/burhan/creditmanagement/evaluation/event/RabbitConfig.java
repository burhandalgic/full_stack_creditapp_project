...
public class RabbitConfig {
    ...
    // credit-evaluation kuyruğu
    @Bean
    public Queue creditApplicationQueue() {
        return new Queue("creditevaluation", false);
    }
    ...
    // credit-evaluation kuyruğu ile exchange arasında binding (bağlantı)
    @Bean
    public Binding bindingCreditApplication(Queue creditApplicationQueue, Exchange eventExchange) {
        return BindingBuilder.bind(creditApplicationQueue).to(eventExchange).with("creditevaluation").noargs();
    }
